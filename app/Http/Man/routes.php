 ...
 * @Description: 首页
 */
$app->get('/', ['as' => 'dashboard',  'middleware' => 'man.auth',  'uses' => 'IndexController@man']);
...
$app->group([
    'prefix' => 'courses',
        ...
        $app->get('subject',            MAN_NAMESPACE . '\Courses\Subject\GetController@getList')
            ->get('subject\get',        MAN_NAMESPACE . '\Courses\Subject\GetController@getSubject')
            ->post('subject\create',    MAN_NAMESPACE . '\Courses\Subject\PostController@createSubject')
            ->post('subject\update',    MAN_NAMESPACE . '\Courses\Subject\PostController@updateSubject')
            ->post('subject\delete',    MAN_NAMESPACE . '\Courses\Subject\PostController@deleteSubject');
    }
);
